...
class LexRankSummarizer(AbstractSummarizer):
    ...
    def __call__(self, document, sentences_count):
        ...
        sentences_words = [self._to_words_set(s) for s in nltk.sent_tokenize(document)]
        ...
        ratings = dict(zip(nltk.sent_tokenize(document), scores))

        return self._get_best_sentences(nltk.sent_tokenize(document), sentences_count, ratings)
