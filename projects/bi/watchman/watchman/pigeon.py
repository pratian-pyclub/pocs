...
# Ratelimiter limiting pigeon at RL_LIMIT actions per RL_PERIOD seconds
...
def post_folder_destroy(src):
    options = { 'path': src }
    print ENDPOINTS['folder_destroy']
    print options
